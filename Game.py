...
#         # Score and Level
#         Text("#f2e30f", 1040, 5, 50, silkscreen, f"Score:").draw(window)
#         Text("#f2e30f", 1150, 50, 60, silkscreen, f"{score}").draw(window)
#         Text("#ffffff", 150, 570, 70, gow, f"{level_name}").draw(window)
#         window.blit(poseImages[level_name], (800, 500))
#         window.blit(clockimg, (10, 10))
#         Text("#1c1e38", 100, 10, 50, silkscreen, f"{remaining_time}").draw(window)
...
#                 level_completed = True
#         else:
#             Text((255, 0, 0), 140, 450, 40, silkscreen, "! Make Sure your whole body is visible").draw(window)
#             window.blit(notvisible, (0, 230))
#             pred = None
...
#         else:
#             window.blit(pygame.transform.scale(title, (800, 800)), (250, -200))
#             Text("#252945", 100, 300, 50, silkscreen, f"Score: {score}").draw(window)
#             Text("#252945", 600, 300, 50, silkscreen, f"Time Played: {int(time_taken)} s").draw(window)
#             Text("#252945", 100, 400, 50, silkscreen, f"HighScore: {high_score}").draw(window)
#             Text("#252945", 600, 400, 50, silkscreen, f"Time / Move: {round(int(time_taken) if score == 0 else time_taken / (score + 1), 2)} s").draw(window)
...
# clockimg = pygame.image.load(r'Images\clock.png').convert_alpha()
# clockimg = pygame.transform.scale(clockimg, (70, 70))
# title = pygame.transform.scale(bg1, (600, 600))
# title_with_man = pygame.transform.scale(bg1, (800, 800))
# gameover = pygame.image.load(r"Images\gameover3.png").convert_alpha()
